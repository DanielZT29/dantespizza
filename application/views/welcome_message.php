  ...
  <div class="container-fluid">
	...
	<a href="<?php echo base_url(); ?>index.php/Pizzeria"><img src="<?php echo base_url();?>resources/img/logo.png" class="logo"></a>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" id="iconos">
                <a href="<?php echo base_url(); ?>index.php/iniciosesion" class="nav-link active" id="user"><i class="fa-solid fa-user"></i>Sign In</a>
	...
	<body>
      ...
      <a href="Pizza/ArmaPizza.html" class="btn btn-outline-danger" style="margin-left: 90%; margin-top: -50%;">Arma tu pizza</a>

...
<main class="container">
        <h1 class="display-3 text-center">Crear nueva sucursal</h1>
        <div class="row">
            <div class="col  ">
                <form action="<?php echo site_url("admin/crearsucursal/save"); ?>"  autocomplete="off"  method="POST"  enctype="multipart/form-data">
                   <div class="form-group mb-3" >
                        <input type="text" name="nombre" placeholder="Nombre Sucursal" class="form-control" >
                    </div>
                    <div class="form-group mb-3" >

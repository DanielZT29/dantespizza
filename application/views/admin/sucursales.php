...
<body><div class="container" id="centrado">
    
   

        <div class="row row-cols-1 row-cols-xs-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4">

        <a href="<?php echo base_url(); ?>index.php/crearsucursal"" class="btn btn-outline-success" style="margin-left: 66%; margin-top: 1%;">Crear nueva sucursal</a>
